...
public class Destination {
	...
	public String toString() {
		return "Destination [zipcode=" + zipcode + ", type=" + type + ", state=" + state + ", portIsoCode="
				+ portIsoCode + ", place=" + place + ", countryIsocode=" + countryIsocode + "]";
	}
...
/*	public Destination(String Zipcode,String Type,String State,String PortIsoCode,String Place,String CountryIsocode) {
		this.Zipcode= Zipcode;
		this.Type=Type;
		this.State=State;
		this.PortIsoCode=PortIsoCode;
