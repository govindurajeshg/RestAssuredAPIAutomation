...
public class DestinationCharge {
	...
	public String toString() {
		return "DestinationCharge [chargeIdentifier=" + chargeIdentifier + ", chargeCode=" + chargeCode
				+ ", chargeName=" + chargeName + ", effectiveDate=" + effectiveDate + ", expiryDate=" + expiryDate
				+ ", currencyIsoCode=" + currencyIsoCode + ", uomCode=" + uomCode + ", containerSize=" + containerSize
				+ ", maximum=" + maximum + ", minimum=" + minimum + ", unitCost=" + unitCost + ", rateapplicability="
				+ rateapplicability + ", notes=" + notes + ", additionalProperties=" + additionalProperties + "]";
	}
