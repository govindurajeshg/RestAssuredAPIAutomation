package com.Agility.dataProvider;
...
import com.Agility.YamlData.AllTestCaseData;
...
public class DataProviderClass {
	...
	@DataProvider(name="RC_test_data_provider")
	public Object[][] getDataFromYamlFile(Method method)
	{
		Yaml yaml = new Yaml();
		AllTestCaseData allTestCaseData = null; 
		String testCasePath = ".\\src\\test\\resources\\testdata\\RC_test_data.yaml";
		...
		/*testDataSets =testDataSets.stream().filter(x -> casesToBeRun.equalsIgnoreCase(x.getTestCategory())).collect(Collectors.toList());*/
